...
public class BarbershopDB {
    ...
    public static BarbershopDB fromModel(Barbershop barbershop) {
        List<ReservationDB> reservations = barbershop.getReservations()
                .stream()
                .map(ReservationDB::fromModel)
        ...
        return BarbershopDB.builder()
                ...
                .availability(AvailabilityDB.fromModel(barbershop.getAvailability()))
                .reservations(reservations)
                .build();
    }


    public static Barbershop toModel(BarbershopDB barbershopDB) {
        List<Reservation> reservations = barbershopDB.getReservations()
                .stream()
                .map(ReservationDB::toModel)
                .collect(Collectors.toList());
        ...
        return Barbershop.builder()
                ...
                .availability(AvailabilityDB.toModel(barbershopDB.getAvailability()))
                .reservations(reservations)
                .build();
    }
}
