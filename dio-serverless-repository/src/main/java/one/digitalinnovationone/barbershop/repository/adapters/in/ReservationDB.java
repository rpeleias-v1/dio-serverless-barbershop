...
public class ReservationDB {
    ...
    public static ReservationDB fromModel(Reservation reservation) {
        return ReservationDB.builder()
                .customer(CustomerDB.fromModel(reservation.getCustomer()))
                .dayOfWeek(reservation.getDayOfWeek().name())
                .time(reservation.getTime())
                .build();
    }

    public static Reservation toModel(ReservationDB reservationDB) {
        return Reservation.builder()
                .customer(CustomerDB.toModel(reservationDB.getCustomer()))
